...
from Preprocessing_utlities import extract_Kidney_center_patch_updated
...
def Save_pngAndmask(a_id,a_lbl,img1,mask1,path):
    ...
    decoding_lbl=[]
    if p_lbl[0]==1:
        decoding_lbl.append('Kidney Normal')
    if p_lbl[1]==1:
        decoding_lbl.append('Kidney Stone')
    if p_lbl[2]==1:
        decoding_lbl.append('Kidney Atrophy')
    if p_lbl[3]==1:
        decoding_lbl.append('Kidney Lesion')
    if p_lbl[4]==1:
        decoding_lbl.append('Kidney Cyst')
    print(decoding_lbl)
